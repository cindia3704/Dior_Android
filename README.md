...
|홈화면 헤더(1주일 달력 뷰)| <img width="358" alt="스크린샷 2021-06-01 오후 6 47 07" src="https://user-images.githubusercontent.com/52744390/120303417-c6a8b800-c309-11eb-96d0-1ab9135c4f46.png"> |김지수|
|홈화면 플로팅 버튼 밒 애니메이션  | <img width="223" alt="스크린샷 2021-06-01 오후 6 47 57" src="https://user-images.githubusercontent.com/52744390/120303537-e4761d00-c309-11eb-86d2-ffacb0c8184a.png">|김지수|
...
- [ ] 스플레위 화면 및 애니메이션 
- [ ] 제플린 0410수정 태그 반영 
- [ ] 마이페이지 할 일 관리 뷰 및 할일 편집
- [ ] 할일 리스트 화면에서 북마크 정렬 기능 
- [ ] 할 일 추가하기 뷰
- [ ] 카테고리 추가 뷰 및 키보드 단어 자동생성 기능 
- [ ] 홈 뷰 - 할일 수정하기에서 카테고리 선택 뷰
- [ ] 이후 나올 회고 뷰 
- [ ] 모든 기능 서버 연결 
- [ ] 그 외에 자잘한 작업들 (자잘한 디자인 수정, 영어 폰트 적용)
     

### Members
|**이름**|**연락처**|**담당 기능 요약**|
|---|------|---|
|김지수|Github: [cindia3704](https://github.com/cindia3704) <br>Contact: cindia3704@gmail.com| - 카카오 로그인<br>- 루틴 목록 뷰<br>- 루틴 이름 입력 <br>- 할일 리스트 화면 <br>- 루틴 최종 화면 <br>- 마이페이지 할 일 관리뷰를 제외한 모든 기능<br>- 홈뷰 자잘한 작업(달력 & 버튼 애니메이션)
|권준혁|Github: [pula39](https://github.com/pula39) <br>Contact: @gmail.com| - 루틴 추가 이후 홈 뷰<br>- 훔뷰 루틴 수정<br>- 훔뷰 루틴 삭제
